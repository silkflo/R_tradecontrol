#' Function check_if_optimize. Purpose of this function is to verify trading system functionality by analyzing
...
check_if_optimize <- function(x, path_trading_robot, num_trades_to_consider = 10, profit_factor_limit = 0.7,
  ...
  # path_trading_robot <- "E:/trading/Git/FALCON_B/"
  # num_trades_to_consider <- 10
  # profit_factor_limit <- 0.5
  # demo_mode <- T
